...
INSERT INTO `categories` VALUES ('c5af21f8-0623-4805-8b5e-571b315a54bf','Calzado'),('2d7405b2-bb31-463c-88ec-d917b7ca63aa','Calzado de patas'),('965017dd-fac4-4d4a-b2bd-c780b6c86f8a','Ropa'),('4494d512-5154-4e6d-84ba-8411524c9e5d','Ropa de invierno');
...
INSERT INTO `users` VALUES ('216131c1-67e5-468e-ba18-b39435dd3063','Renzo yaques','renzoyaques@gmail.com','$2b$12$URx1nN7CnxWqffZghn7Qe.l2je4NyH7AgqOBysLyZHAQzjOfhx.Ze','admin','2024-03-03 00:49:06','2024-03-03 00:49:19');
...
BEGIN
    ...
    ELSE
        ...
        IF v_category_id IS NULL THEN
            ...
            SET v_category_id = p_category_id; -- Utilizar la id proporcionada
        END IF;
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM shopping_cart WHERE customer_id = p_id;

    IF v_count != 0 THEN
        DELETE FROM shopping_cart WHERE customer_id = p_id;
    END IF;
...
-- Dump completed on 2024-03-03 12:38:56
