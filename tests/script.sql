...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema ecommerce_db_test
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema ecommerce_db_test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ecommerce_db_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `ecommerce_db_test` ;

-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`users` (
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`categories` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`products` (
  `id` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_products_category_id`
    ...
    REFERENCES `ecommerce_db_test`.`categories` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`cart`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`cart` (
  `id` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_cart_product_id`
    ...
    REFERENCES `ecommerce_db_test`.`products` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`order_details` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`address` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`payment_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`payment_details` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`orders` (
  `id` VARCHAR(36) NOT NULL,
  `customer_id` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_orders_address_id`
    ...
    REFERENCES `ecommerce_db_test`.`address` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_payment_details1`
    FOREIGN KEY (`payment_id`)
    REFERENCES `ecommerce_db_test`.`payment_details` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_order_details1`
    FOREIGN KEY (`details_id`)
    REFERENCES `ecommerce_db_test`.`order_details` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`product_reviews`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`product_reviews` (
  `id` VARCHAR(36) NOT NULL,
  `product_id` VARCHAR(36) NOT NULL,
  `user_id` VARCHAR(36) NOT NULL,
  `rating` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`discounts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`discounts` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`product_discounts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`product_discounts` (
  `id` VARCHAR(36) NOT NULL,
  `product_id` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_discount_discount_id`
    ...
    REFERENCES `ecommerce_db_test`.`discounts` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`taxes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`taxes` (
  `id` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db_test`.`order_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce_db_test`.`order_items` (
  `id` VARCHAR(36) NOT NULL,
